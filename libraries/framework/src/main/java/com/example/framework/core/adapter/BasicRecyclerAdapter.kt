package com.example.framework.core.adapter
...
abstract class BasicRecyclerAdapter<T : Any, Binding : ViewBinding> :
    RecyclerView.Adapter<com.example.framework.core.adapter.BasicViewHolder<Binding>>() {
    ...
    open fun getViewHolder(viewBinding: Binding): com.example.framework.core.adapter.BasicViewHolder<Binding> {
        return com.example.framework.core.adapter.BasicViewHolder(viewBinding)
    }

    /** Generates a ViewHolder from this Item with the given parent */
    private fun getViewHolder(parent: ViewGroup): com.example.framework.core.adapter.BasicViewHolder<Binding> {
        return getViewHolder(createBinding(LayoutInflater.from(parent.context), parent))
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): com.example.framework.core.adapter.BasicViewHolder<Binding> {
        return getViewHolder(parent)
    }

    override fun onBindViewHolder(holder: com.example.framework.core.adapter.BasicViewHolder<Binding>, position: Int) {
